...
- Active slice: S6 editor resilience, accessibility and viewport hardening. Source of truth: `evidence/QA-002/S6_RESILIENCE_ACCESSIBILITY_PLAN.md`. S6.1 will add truthful failure classification, retry, opt-in autosave, bounded local recovery and explicit session-expiry/concurrency recovery before S6.2 completes keyboard, screen-reader, touch and required-viewport overlay behavior. QA-002 and QA-003 remain REOPENED throughout implementation and final release rows are not self-approved.
