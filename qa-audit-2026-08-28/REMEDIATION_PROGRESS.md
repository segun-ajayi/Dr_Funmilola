...
| QA-015 | 12 | IN PROGRESS | Patient/account/role admin operations pass role/audit edge cases | Step 12 execution plan recorded below; evidence folder `evidence/QA-015` |
...
| QA-021 | 12 | IN PROGRESS | Password reset revokes other web sessions and mobile/API tokens | Step 12 database-session implementation and regression in progress; Redis session retest remains blocked; evidence folder `evidence/QA-021` |
...
| QA-023 | 12 | IN PROGRESS | Audit catalogue actions produce safe actor/resource/before-after records | Step 12 catalogue, safe changes and query regression in progress; evidence folder `evidence/QA-023` |
