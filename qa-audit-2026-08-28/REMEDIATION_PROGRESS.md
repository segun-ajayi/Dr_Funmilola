...
- Next active slice: S4 actual-page navigation editing and page lifecycle. Source of truth: `evidence/QA-002/S4_NAVIGATION_PAGES_PLAN.md`; S4.1 starts with rendered-header selection, a safe structured navigation schema, root/submenu lifecycle, private draft save and explicit publication.
