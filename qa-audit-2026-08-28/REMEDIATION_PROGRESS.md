...
- Next active slice: S4 actual-page navigation editing and page lifecycle, beginning with a committed source-of-truth plan derived from the atomic VE acceptance rows.
